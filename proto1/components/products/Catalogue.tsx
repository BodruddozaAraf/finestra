...
import { CATALOGUE, LINES, type Line, type Product } from "@/proto1/lib/catalogue";
    ...
    <>
      <div className="mx-auto max-w-[1400px] px-4 sm:px-7">
        <div className="grid gap-8 lg:grid-cols-[220px_1fr] lg:gap-10">
          ...
          <aside className="min-w-0 lg:sticky lg:top-[138px] lg:self-start">
      ...
      <BagRail lines={lines} onRemove={remove} onCheckout={checkout} notice={notice} />
    </>
  );
}
